        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            <p className="text-gray-600 mt-2">
              Sign in to your Stayverz account
            </p>
          </motion.div>
        </motion.div>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                >
                  <Link 
                    ...
                    className="text-sm text-[#f15a26] hover:text-[#d14a1e] transition-colors"
                  >
                    Forgot password?
                  </Link>
                </motion.div>
            ...
            >
              <Button
                type="submit"
                className="w-full h-12 bg-[#f15a26] hover:bg-[#d14a1e] text-white text-base font-medium rounded-lg transition-colors shadow-lg hover:shadow-xl"
              >
                Sign In
              </Button>
            </motion.div>
